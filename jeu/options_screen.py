...
def options_screen(screen: pygame.surface.Surface):
    ...
    timer_label: pygame.surface.Surface = options_font.get_font(56).render("Timer", True, "white")
    timer_label_rect: pygame.rect.Rect = timer_label.get_rect(center=(200//2+MARGIN, options_popup.surface.get_size()[1]//2*0.45))
